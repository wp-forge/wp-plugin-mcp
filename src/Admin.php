...
class Admin {
	...
	public function render_page() {
		...
		<div class="wrap">
			...
			<p><?php esc_html_e( 'All MCP tools exposed by this plugin use the wp-forge prefix, such as wp-forge-search-content and wp-forge-get-site-info.', 'wp-plugin-mcp' ); ?></p>
