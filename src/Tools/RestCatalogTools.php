...
trait RestCatalogTools {
	...
	private function add_rest_catalog_abilities() {
		$this->add_ability( self::INTERNAL_PREFIX . 'api_function_list', 'List API Functions', 'List available WordPress REST API endpoints that support CRUD', $this->schema(
			array(
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'api_function_run', 'Run API Function', 'Execute a REST API request by route, method, and parameters', $this->schema(
			array(
				'route'      => $this->string_prop( 'REST route.' ),
				'method'     => $this->string_prop( 'HTTP method.' ),
