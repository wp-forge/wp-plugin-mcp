...
trait GlobalStylesTools {
	...
	private function add_style_abilities() {
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'global-styles-get', 'Get Global Styles', 'Get a global styles configuration by ID', $id_schema, function ( $params ) {
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'global-styles-active-id-get', 'Get Active Global Styles ID', 'Get the active global styles ID', $this->schema(), function () {
