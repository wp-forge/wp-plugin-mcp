...
trait OptionManagementTools {
	...
	private function add_option_abilities() {
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'option_list', 'List Options', 'List WordPress options by search or prefix', $this->schema(
			array(
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'option_get', 'Get Option', 'Get a WordPress option value by name', $option_schema, function ( $params ) {
			return $this->get_option_tool( $params['option_name'] );
		}, true, 'manage_options' );

		$this->add_ability( self::INTERNAL_PREFIX . 'option_save', 'Save Option', 'Create or update a WordPress option value by name', $this->schema(
			array(
				'option_name' => $this->string_prop( 'Option name.' ),
		...
		$this->add_ability( self::INTERNAL_PREFIX . 'option_delete', 'Delete Option', 'Delete a WordPress option by name', $option_schema, function ( $params ) {
